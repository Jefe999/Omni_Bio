#!/usr/bin/env python3
"""
Test for Task #11 - Statistical Analysis (t-tests, volcano plots)
Tests the new statistical analysis module with t-tests and volcano plots
"""
...
def test_statistical_analysis():
    ...
    try:
        ...
        from biomarker.ml.statistical_analysis import run_complete_statistical_analysis
        import pandas as pd
        ...
        for filename, description in optional_files.items():
            ...
            if file_path.exists():
                ...
                print(f"ℹ {description}: Not generated (plotly not available)")
...
if __name__ == '__main__':
    print("Testing Task #11 - Statistical Analysis")
    print("=" * 50)
    
    success = test_statistical_analysis()
    
    if success:
        print("\n✅ Task #11 is ready! Moving to next task...")
